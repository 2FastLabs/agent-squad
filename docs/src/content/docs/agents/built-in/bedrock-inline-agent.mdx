...
- [TypeScript Sample](https://github.com/2fastlabs/agent-squad/tree/main/examples/bedrock-inline-agents/typescript)
- [Python Sample](https://github.com/2fastlabs/agent-squad/tree/main/examples/bedrock-inline-agents/python)
