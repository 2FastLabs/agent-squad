...
<Tabs syncKey="runtime">
  <TabItem label="TypeScript" icon="seti:typescript" color="blue">
    ...
    // Note: name/description are required by AgentOptions but are actually
    // ignored at runtime — SupervisorAgent always overwrites them with
    // leadAgent.name / leadAgent.description ("Travel Coordinator" here).
  ...
  <TabItem label="Python" icon="seti:python">
    ...
    # Note: name/description are required fields but are actually ignored
    # at runtime — SupervisorAgent always overwrites them with
    # lead_agent.name / lead_agent.description ("Travel Coordinator" here).
...
<Tabs syncKey="runtime">
  <TabItem label="TypeScript" icon="seti:typescript" color="blue">
    ...
    const retriever = new AmazonKnowledgeBasesRetriever(client, {
